...
WEIGHTS = "runs_agropest12/baseline_yolo11n3/weights/last.pt"
IMAGE_PATH = "valid/images/ants-22-_jpg.rf.88f93a444c0badf57495258b68ace2d9.jpg"
IMG_SIZE = 640
...
def main():
    ...
    yolo = YOLO(WEIGHTS)
    print("Class names from model:", yolo.names)
    print("Target:", TARGET_CLASS_NAME)
    ...
    out_path = "yolo11_gradcam_single.jpg"
